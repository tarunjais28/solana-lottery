...
pub enum LendingError {
    ...
    InvalidTokenProgram,
    /// Whitelist length exceed WHITELIST_MAX_LENGTH
    #[error("Whitelist length exceed WHITELIST_MAX_LENGTH")]
    InvalidWhitelistLength,
    /// lending market owner does not match the lending_market provided
    #[error("lending market owner does not match the lending_market provided")]
    InvalidLendingMarketOwner,
    // 10
    ...
    #[error("Strategy deposits have zero value")]
    StrategyDepositsZero,
    /// Strategy borrows have zero value
    #[error("Strategy borrows have zero value")]
    StrategyBorrowsZero,
    /// Invalid strategy collateral
    #[error("Invalid strategy collateral")]
    InvalidStrategyCollateral,
    /// Invalid obligation liquidity
    #[error("Invalid obligation liquidity")]
    InvalidStrategyLiquidity,
    /// Strategy collateral is empty
    #[error("Strategy collateral is empty")]
    StrategyCollateralEmpty,

    // 40
    /// Strategy liquidity is empty
    #[error("Strategy liquidity is empty")]
    StrategyLiquidityEmpty,
