...
export async function init(program_id: PublicKey, superadmin: PublicKey, admin: PublicKey, investor: PublicKey, usdc_mint: PublicKey, vrfProgramId: PublicKey): Promise<TransactionInstruction> {
	return instruction(
		program_id,
		[
